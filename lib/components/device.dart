...
class _SystemDeviceTileState extends State<SystemDeviceTile> {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      title: Text(widget.device.platformName.isEmpty?"No Platform Name":widget.device.platformName,style: TextStyle(color: Theme.of(context).primaryColor),),
      subtitle: Text(widget.device.remoteId.str,style: const TextStyle(color: Colors.white)),
